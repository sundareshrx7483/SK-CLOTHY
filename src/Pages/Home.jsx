    ...
    <div id="home" className="flex items-center justify-center w-full h-screen">
      <Carousel className="w-full h-full">
        <div className="relative flex items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
          ...
          <img
            src="src/assets/images/Home/wp6326224-mens-fashion-wallpapers.jpg"
            alt="Fashion"
        ...
        <div className="relative flex items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
          <img
            src="src/assets/images/Home/wp5611603-men-and-women-fashion-models-wallpapers.jpg"
        ...
        <div className="relative flex items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
          <img
            src="src/assets/images/Home/img6.jpg"
            alt="Fashion Image 3"
            className="object-cover w-full h-full"
          />
        </div>
        ...
        <div className="relative flex items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
          <img
            src="src/assets/images/Home/img3.jpg"
            alt="Fashion Image 4"
            className="object-cover w-full h-full"
          />
        </div>
        ...
        <div className="relative flex items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
          <img
            src="src/assets/images/Home/img5.jpg"
            alt="Fashion Image 5"
            className="object-cover w-full h-full"
          />
        </div>
